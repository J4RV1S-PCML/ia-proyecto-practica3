...
class TestCalculadoraUnidades(unittest.TestCase):
    ...
    def test_metros_a_kilometros(self):
        self.assertEqual(CalculadoraUnidades.metros_a_kilometros(1000000), 1)
        self.assertEqual(CalculadoraUnidades.metros_a_kilometros("2000000"), 2)
    ...
    def test_kilometros_a_metros(self):
        self.assertEqual(CalculadoraUnidades.kilometros_a_metros(2), 2000000)
        self.assertEqual(CalculadoraUnidades.kilometros_a_metros("3"), 3000000)
